...
async function handleIndexPage() {
    let data = {};
    try {
        const res = await lib_axios.get('/api/all');
        data = res.data;
    } catch (error) {
...
async function handleDetailPage(clientName) {
    ...
    if (data.stats.hasOwnProperty("lambda-profile")) {
        ...
        const mainChart = new (apexcharts_common_default())(document.getElementById('main-chart'), mainChartOptions);
        mainChart.render();
    }
    ...
    const statsChart = new (apexcharts_common_default())(document.getElementById('stats-avg-duration-chart'), staticOptions);
    statsChart.render();
...
const charts_getMainChartOptions = () => {
    let mainChartColors = {}
